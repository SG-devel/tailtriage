...
#[test]
fn run_builder_request_duration_is_authoritative_when_timestamps_disagree() {
    let mut builder = crate::RunBuilder::new(crate::RunBuilderOptions::new("svc")).expect("ok");
    ...
    builder.push_request(request).expect("request is valid");
...
#[test]
fn run_builder_stage_duration_is_authoritative_when_timestamps_disagree() {
    let mut builder = crate::RunBuilder::new(crate::RunBuilderOptions::new("svc")).expect("ok");
    ...
    builder.push_stage(stage).expect("stage is valid");
...
#[test]
fn run_builder_queue_wait_is_authoritative_when_timestamps_disagree() {
    let mut builder = crate::RunBuilder::new(crate::RunBuilderOptions::new("svc")).expect("ok");
    ...
    builder.push_queue(queue).expect("queue is valid");
