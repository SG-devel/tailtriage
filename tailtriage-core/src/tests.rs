...
#[test]
fn run_builder_request_duration_field_is_authoritative() {
    let mut builder = crate::RunBuilder::new(crate::RunBuilderOptions::new("svc")).expect("ok");
    ...
    builder.push_request(request).expect("duration retained");
...
#[test]
fn run_builder_stage_duration_field_is_authoritative() {
    let mut builder = crate::RunBuilder::new(crate::RunBuilderOptions::new("svc")).expect("ok");
    ...
    builder.push_stage(stage).expect("duration retained");
...
#[test]
fn run_builder_queue_wait_field_is_authoritative() {
    let mut builder = crate::RunBuilder::new(crate::RunBuilderOptions::new("svc")).expect("ok");
    ...
    builder.push_queue(queue).expect("wait retained");
