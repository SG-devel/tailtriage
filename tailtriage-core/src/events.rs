...
pub struct RequestEvent {
    ...
    pub started_at_unix_ms: u64,
    /// Request start offset from run start (monotonic microseconds).
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub started_at_run_us: Option<u64>,
    /// Request completion timestamp (milliseconds since epoch UTC).
    pub finished_at_unix_ms: u64,
    /// Request completion offset from run start (monotonic microseconds).
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct StageEvent {
    ...
    pub started_at_unix_ms: u64,
    /// Stage start offset from run start (monotonic microseconds).
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub started_at_run_us: Option<u64>,
    /// Stage completion timestamp (milliseconds since epoch UTC).
    pub finished_at_unix_ms: u64,
    /// Stage completion offset from run start (monotonic microseconds).
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub finished_at_run_us: Option<u64>,
...
pub struct QueueEvent {
    ...
    /// Queue wait start offset from run start (monotonic microseconds).
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub waited_from_run_us: Option<u64>,
    /// Queue wait end timestamp (milliseconds since epoch UTC).
    pub waited_until_unix_ms: u64,
    /// Queue wait end offset from run start (monotonic microseconds).
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct InFlightSnapshot {
    ...
    pub at_unix_ms: u64,
    /// Snapshot offset from run start (monotonic microseconds).
    #[serde(default, skip_serializing_if = "Option::is_none")]
