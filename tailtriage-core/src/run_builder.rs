...
/// request lifecycle tracking. Elapsed duration fields such as
/// `RequestEvent::latency_us`, `StageEvent::latency_us`, and
/// `QueueEvent::wait_us` are accepted as authoritative completed evidence.
/// [`RunBuilder`] does not synthesize or repair durations from timestamps.
///
