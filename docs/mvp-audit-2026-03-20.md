...
- M1 `tailtriage-core`: met
- M2 request macro: met
- M3 `tailtriage-tokio`: met
- M4 `tailtriage-cli`: met
...
- `(removed in unified API migration)` exists as a dedicated proc-macro crate to support macro path removed; use `RequestContext`
