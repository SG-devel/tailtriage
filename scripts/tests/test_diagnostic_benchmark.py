...
class DiagnosticBenchmarkTests(unittest.TestCase):
    ...
    def test_duplicate_ids_and_unknown_ground_truth(self):
        base = {
            ...
            "tags": [], "must_include_evidence": [], "expected_warnings": [], "top1_required": False, "notes": "n"
        }
        with self.assertRaises(ValueError):
    ...
    def test_acceptable_top2_must_include_ground_truth(self):
        with self.assertRaises(ValueError):
            db.validate_manifest({"schema_version": 1, "cases": [{"id": "1", "artifact": "a.json", "artifact_type": "analysis_report", "ground_truth": "insufficient_evidence", "acceptable_top2": ["application_queue_saturation"], "tags": [], "must_include_evidence": [], "expected_warnings": [], "top1_required": False, "notes": "x"}]})
    ...
    def test_metrics_evidence_warnings_buckets_and_threshold_failure(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            manifest = {"schema_version": 1, "cases": [
                {"id": "c1", "artifact": "ok.json", "artifact_type": "analysis_report", "ground_truth": "application_queue_saturation", "acceptable_top2": ["application_queue_saturation"], "tags": [], "must_include_evidence": ["Queue wait"], "expected_warnings": [], "top1_required": True, "notes": "n"},
                {"id": "c2", "artifact": "bad.json", "artifact_type": "analysis_report", "ground_truth": "application_queue_saturation", "acceptable_top2": ["application_queue_saturation", "blocking_pool_pressure"], "tags": [], "must_include_evidence": ["Queue wait"], "expected_warnings": ["runtime signal missing"], "top1_required": False, "notes": "n"}
            ]}
    ...
    def test_json_output_shape_stable(self):
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            mpath = self._write(root, "manifest.json", {"schema_version": 1, "cases": [{"id": "x", "artifact": "a.json", "artifact_type": "analysis_report", "ground_truth": "insufficient_evidence", "acceptable_top2": ["insufficient_evidence"], "tags": [], "must_include_evidence": ["Not enough"], "expected_warnings": [], "top1_required": False, "notes": "n"}]})
    ...
    def test_top2_miss_and_missing_expected_warning_fail_case(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            manifest = {"schema_version": 1, "cases": [{"id": "x", "artifact": "a.json", "artifact_type": "analysis_report", "ground_truth": "application_queue_saturation", "acceptable_top2": ["application_queue_saturation"], "tags": [], "must_include_evidence": [], "expected_warnings": ["runtime signal missing"], "top1_required": False, "notes": "n"}]}
            mpath = self._write(root, "manifest.json", manifest)
    ...
    def test_top1_required_and_high_confidence_wrong_gate(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            manifest = {"schema_version": 1, "cases": [{"id": "x", "artifact": "a.json", "artifact_type": "analysis_report", "ground_truth": "application_queue_saturation", "acceptable_top2": ["application_queue_saturation", "blocking_pool_pressure"], "tags": [], "must_include_evidence": [], "expected_warnings": [], "top1_required": True, "notes": "n"}]}
            mpath = self._write(root, "manifest.json", manifest)
