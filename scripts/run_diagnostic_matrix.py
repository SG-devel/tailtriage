...
SCENARIO_MATRIX = {
    ...
    "executor": {
        "variant": "before",
        "demo_mode": "baseline",
        "ground_truth": "executor_pressure",
        "acceptable_primary": ["executor_pressure"],
        "required_top2": ["executor_pressure"],
        "top1_required": True,
    },
    "downstream": {
        "variant": "before",
        "demo_mode": "baseline",
        "ground_truth": "downstream_stage_dominance",
        "acceptable_primary": ["downstream_stage_dominance", "application_queue_pressure"],
        "required_top2": ["downstream_stage_dominance"],
        "top1_required": True,
    },
    "mixed": {
        "variant": "before",
        "demo_mode": "baseline",
        "ground_truth": "application_queue_pressure",
        "acceptable_primary": ["application_queue_pressure", "executor_pressure"],
        "required_top2": ["application_queue_pressure"],
        "top1_required": False,
    },
}
