#!/usr/bin/env python3
"""Run blocking demo and generate analysis artifact."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run blocking demo and analyze output.")
    parser.add_argument(
        "artifact_path",
        nargs="?",
...
def main() -> None:
    ...
    artifact_path = (
        ...
        else root_dir / "demos/blocking_service/artifacts/blocking-run.json"
    )
