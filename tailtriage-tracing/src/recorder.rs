...
mod tests {
    ...
    #[test]
    fn completed_span_jsonl_path_only_rejects_zero_requests_without_creating_file() {
        let dir = tempfile::tempdir().unwrap();
        let spans_path = dir.path().join("spans.jsonl");
        let session = TracingIntakeSession::builder("svc")
            .completed_span_jsonl_path(&spans_path)
    ...
    #[test]
    fn shutdown_without_persisted_paths_allows_zero_request_in_process_inspection() {
