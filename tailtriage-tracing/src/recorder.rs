...
mod tests {
    ...
    #[test]
    fn finish_unix_ms_from_started_and_duration_rounds_up_positive_microseconds() {
    ...
    #[test]
    fn finish_unix_ms_from_started_and_duration_saturates_overflow() {
        assert_eq!(
    ...
    fn strict_snapshot_run_succeeds_for_completed_request_span() {
        ...
        assert_eq!(run.run().requests[0].route, "/strict");
    }

    #[test]
    fn completed_request_span_records_positive_latency_from_monotonic_duration() {
        let recorder = TracingRecorder::builder("svc")
            .strict(true)
            .build()
            .unwrap();
