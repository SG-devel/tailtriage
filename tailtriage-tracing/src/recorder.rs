...
impl TracingIntakeSessionBuilder {
    ...
    ///
    /// This output is intended for replaying retained request/stage/queue evidence through
    /// `tailtriage import`, not for trace archival. It does not preserve original tracing span
    /// names, span IDs, parent IDs, or non-`tt.*` fields.
    #[must_use]
