...
- Live tracing samples finish wall time when a span closes; it does not synthesize close timestamps from elapsed duration.
- `duration_us` remains the authoritative elapsed-time evidence when supplied.
