...
pub(crate) fn apply_evidence_aware_confidence_caps(
...
pub(crate) fn apply_family_evidence_caps(
    kind: &DiagnosisKind,
    run: &Run,
...
pub(crate) fn ambiguity_cluster_indices(suspects: &[Suspect]) -> Vec<usize> {
